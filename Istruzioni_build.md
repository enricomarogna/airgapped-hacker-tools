# Istruzioni per la staticizzazione dei siti
Alcuni dei siti di questo repo devo essere staticizzati per poter essere consultati offline o per evitare di doverli hostare.
Di seguito alcune istruzioni utili.
...
Questo genera la cartella `_site` con i file statici
